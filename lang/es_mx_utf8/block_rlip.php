...
$string['couldnotopenexportfile'] = 'No se pudo abrir el archivo de exportaciÃ³n: $a';
$string['course'] = 'Curso';
...
$string['enrolment'] = 'InscripciÃ³n';
$string['enrol_properties'] = 'Mapa de las propiedades de inscripciÃ³n';

$string['export_location_missing'] = 'UbicaciÃ³n del archivo de exportaciÃ³n es que falta. Por favor, asegÃºrese rlip fue configurado correctamente.';
$string['export_now'] = 'Exportar ahora';
$string['exportallhistorical'] = 'Incluya todos los datos histÃ³ricos';
$string['exportfilelocation'] = 'Exportar UbicaciÃ³n del archivo';
$string['exportfiletimestamp'] = 'Nombres Ãnicos de archivos de exportaciÃ³n';
$string['exportperiod'] = 'PerÃ­odo de ExportaciÃ³n';
...
$string['export_header_course_idnumber'] = 'NÃºmero de identificaciÃ³n de curso';
$string['export_header_start_date'] = 'Fecha de inicio';
$string['export_header_end_date'] = 'Fecha de finalizaciÃ³n';
$string['export_header_status'] = 'Estatus';
$string['export_header_grade'] = 'CalificaciÃ³n';
...
$string['export_config_form_add'] = 'AÃ±adir';
$string['export_config_form_update'] = 'Actualizar';
$string['export_config_duplicate_header_error'] = 'Por favor, elija un nombre de columna Ãºnica';

$string['export_config_instructions'] = 'En la actualidad, no hay campos de perfil se incluyen en la exportaciÃ³n.  Para aÃ±adir esta informaciÃ³n a la exportaciÃ³n, agregue los campos que desee a travÃ©s de la interfaz anterior.';

$string['mapping_column_header'] = 'Encabezado de columna';
$string['mapping_profile_field'] = 'Perfil de campo';

$string['filelocation'] = 'Importar ubicaciÃ³n del archivo';
$string['filename'] = 'Nombre de archivo';
$string['filetype'] = 'Tipo de Campo';
$string['general'] = 'General';
$string['generalimportinfo'] = 'Este se verifica para los archivos de formato especial en un lugar especÃ­fico y importa los datos dentro de un sistema de gestiÃ³n del plan de estudios.<br />';

$string['import_all'] = 'Importar todo';
$string['import_location_missing'] = 'UbicaciÃ³n del archivo de importaciÃ³n no se encuentra. Por favor, asegÃºrese rlip fue configurado correctamente.';
...
$string['configexport'] = '';
$string['elis'] = 'ELIS';
$string['configelis'] = 'ConfiguraciÃ³n de esta secciÃ³n se aplican especÃ­ficamente a los sitios de ejecuciÃ³n ELIS.';

$string['configcreategroups'] = 'Si se activa,crear automÃ¡ticamente nuevos grupos y agrupaciones en el curso especificado.';
$string['configdateformat'] = 'Establezca el formato de la fecha prevista de importaciÃ³n.';
$string['configemailnotification'] = 'Una lista separada por comas de los nÃºmeros de identificaciÃ³n de los usuarios a enviar el log de acciones a travÃ©s de correo electrÃ³nico (en blanco sin ninguna notificaciÃ³n).';
$string['configexportallhistorical'] = 'Al seleccionar esta opciÃ³n se incluyen toda la informaciÃ³n conclusiÃ³n histÃ³rica, tanto en el manual y programa de ejecuciones de la exportaciÃ³n. Si no estÃ¡ seleccionado, sÃ³lo los datos modificados en el Ãºltimo dÃ­a se incluirÃ¡n en las ejecuciones manual, y sÃ³lo los datos modificados desde la Ãºltima ejecuciÃ³n previsto se incluye el programa de ejecuciones.';
...
$string['filenotdefined'] = 'Archivo de ExportaciÃ³n no se define';
$string['filerecordwriteerror'] = 'No se puede escribir la lÃ­nea $a';
...
$string['nodata'] = 'No hay datos de finalizaciÃ³n de usuario para crear';
$string['noparams'] = 'Los parÃ¡metros no inicializado, no puede crear archivo csv locales para la carga';
$string['recordadded'] = 'Datos del usuario: nÃºmero de ID de usuario $a->userno - ha sido Curso nÃºmero de identificaciÃ³n $a->coursecode aÃ±adido';
$string['skiprecord'] = 'O bien el nÃºmero identificador de usuario $a->usridnumber o nÃºmero de IdentificaciÃ³n del curso $a->crsidnumber estaba vacÃ­o - saltar registro por falta de espacio requerido (s) ';

$string['nopermissions'] = 'Lo sentimos, usted no tiene los permisos necesarios para realizar esta acciÃ³n';
?>
